          ...
          <div class="list-box">
            <div class="as-title">
              <div class="event-align">
                ...
                <button class="pretendard-regular-normal-mine-shaft-16px" @click="EditEvent">수정하기</button>
              </div>
