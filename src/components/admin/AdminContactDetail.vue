    ...
    <div class="wrap">
      <div class="reservation-container">
        ...
        <div class="wrapper">
          <!-- 타이틀 부분 -->
          <div class="title-box">
            <h2 class="pretendard-bold-normal-black-28px">고객센터</h2>
          </div>
          <div class="list-box">
            <div class="as-title">
           ...
           <button class="list-btn pretendard-medium-white-18px" @click="toGoList()">
              ...
              <!-- 24.12.12 수정 - 폰트 수정 -->
              <button class="answer-insert pretendard-semi-bold-black-20px" @click="answerInquiry">답변등록</button>
            </div>
...
export default {
  ...
  methods: {
    ...
    async getContactDt() {
      try {
        const response = await adminStore.getTask(`inquiries/${this.id}`);
    ...
    async answerInquiry() {
      try {
        ...
        const response = await adminStore.updateTask(`inquiries/${this.id}`, params);
